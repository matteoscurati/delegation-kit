...
| GLM-5.3-Flash/max | none (staged candidates) | Official model code and Coding Plan availability are verified, but the earlier ox-alpha diagnostic used another transport. Clerk, scout, and builder remain candidate/blocked until the exact Claude-to-Z.AI pack passes; reviewer is disabled. |
